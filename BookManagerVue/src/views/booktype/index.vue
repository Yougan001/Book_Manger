<template>
  <div class="app-container">
    ...
    <div class="filter-container" style="margin-bottom: 15px">
      ...
      <br>
      <!-- 一些按钮 -->
      <el-button v-waves class="filter-item" style="font-size: 20px" type="primary" icon="el-icon-a-042" @click="handleFilter">
        搜索
      </el-button>
      <el-button v-waves class="filter-item" style="font-size: 20px" type="primary" icon="el-icon-a-041" @click="handleShowAll">
        显示全部
      </el-button>
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-button @click="handleUpdate(scope.row)" type="primary" icon="iconfont icon-r-edit" style="font-size: 16px;"> 编辑</el-button>
          <el-button @click="handleDelete(scope.row,scope.$index)" type="danger" icon="iconfont icon-r-delete" style="font-size: 16px;"> 删除</el-button>
        </template>
      </el-table-column>
    </el-table>
